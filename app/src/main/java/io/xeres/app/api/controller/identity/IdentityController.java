...
public class IdentityController
{
	...
	public ResponseEntity<InputStreamResource> downloadImageByGxsId(@RequestParam(value = "gxsId") String gxsId, @RequestParam(value = "find", defaultValue = "false") boolean find)
	{
		byte[] image = null;
