...
import io.xeres.app.crypto.pgp.PGPKeySpecs;
...
public class ProfileService
{
	...
	private static final int KEY_SIZE = PGPKeySpecs.getKeySize();
	...
	public ResourceCreationState generateProfileKeys(String name, ScrambledString passphrase)
	{
		...
		log.info("Generating PGP keys, algorithm: {}, bits: {} ...", PGPKeySpecs.getAlgorithmName(), KEY_SIZE);
	...
	{
		ProfileFileUtils.saveSecretProfileKey(pgpSecretKey);
	}
	...
	public void changeProfilePassphrase(ScrambledString oldPassphrase, ScrambledString passphrase)
	{
		try
		{
			...
			var newSecretKey = PGP.changePassphrase(pgpSecretKey, oldPassphrase, passphrase);
	...
	public boolean hasSecretProfileKey()
	{
		return ProfileFileUtils.hasSecretProfileKey();
	}

	public byte[] getSecretProfileKey()
	{
		return ProfileFileUtils.getSecretProfileKey();
	}
