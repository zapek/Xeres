...
import static io.xeres.app.xrs.serialization.DoubleSerializer.deserialize;
import static io.xeres.app.xrs.serialization.DoubleSerializer.serialize;
...
class DoubleSerializerTest
{
	...
	{
		TestUtils.assertUtilityClass(DoubleSerializer.class);
	}
