...
import static io.xeres.app.xrs.serialization.FloatSerializer.deserialize;
import static io.xeres.app.xrs.serialization.FloatSerializer.serialize;
...
class FloatSerializerTest
{
	...
	{
		TestUtils.assertUtilityClass(FloatSerializer.class);
	}
