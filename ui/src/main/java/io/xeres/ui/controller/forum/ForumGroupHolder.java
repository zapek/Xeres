...
public class ForumGroupHolder
{
	...
	public ForumGroupHolder()
	{
		forumGroup = new ForumGroup("");
	}

	public ForumGroupHolder(String name)
	{
		forumGroup = new ForumGroup(name);
	}

	public ForumGroupHolder(ForumGroup forumGroup)
	{
		this.forumGroup = forumGroup;
	}

	public ForumGroup getForum()
	{
		return forumGroup;
	}
