...
abstract class StickerLottieAbstract implements Sticker
{
	protected static final Logger log = LoggerFactory.getLogger(StickerLottieAbstract.class);

	private final Path filePath;
	protected Animation animation;

	protected StickerLottieAbstract(Path filePath)
	{
